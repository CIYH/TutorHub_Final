<%-- 
    Document   : authencation-login
    Created on : Jun 28, 2025, 8:49:57 AM
    Author     : qnhat
--%>
                                ...
                                <div class="card mb-0">
                                    <div class="card-body">
                                        ...
                                        <form action="<c:url value='/login' />" method="POST">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Tài khoản Email</label>
                                            ...
                                            <%-- Sửa thẻ <a> thành <button type="submit"> --%>
                                            <button type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Sign In</button>

                                            <div class="d-flex align-items-center justify-content-center">
                                                <p class="fs-4 mb-0 fw-bold">Người dùng mới?</p>
                                                <a class="text-primary fw-bold ms-2" href="<c:url value='/register' />">Tạo tài khoản</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
