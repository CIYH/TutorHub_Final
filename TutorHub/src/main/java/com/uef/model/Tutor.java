...
public class Tutor extends People implements Serializable {
    ...
    public Tutor(String id, String pName, String email, String address, String gender, String phonenumber, String active, String password, int fee, String rating, Integer subId, String education, String experience, Subject subject) {
    ...
    public String toString() {
        return "Tutor{"
                ...
                + ", subject=" + (subject != null ? subject.getSuName() : "null")
                + '}';
    }
